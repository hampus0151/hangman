...
public class gubbe {
    public static void main(String[] args){
        ...
        String[] guesses = {"distinction","ghost","gas","move","death","dog","welcome","school"};
        ...
        while (weArePlaying) {
            ...
            while (!wordIsGuessed && tries != amountOfGuesses){
                ...
                if (input == '-') {
                    ...
                    if (isTheWordGuessed(playerGuess)) {
                        wordIsGuessed = true;
                        System.out.println("congrads comrade");
                    }
            ...
            if (!wordIsGuessed) System.out.println("you have no guesses left :(");
